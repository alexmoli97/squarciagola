...
class SpotifyAuth(context: Context) {
     ...
     *
     * La libreria di autorizzazione di Spotify e' stata provata al posto di questo: presenta
     * il consenso dentro l'app Spotify, ma non inoltra i parametri liberi in cui viaggia il
     * code challenge. Il codice tornava emesso senza PKCE, e riscattarlo avrebbe richiesto il
     * client secret, che in un APK non ci va. Meglio il browser e il refresh token.
     */
